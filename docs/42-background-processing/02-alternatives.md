...
# Cron Alternatives
This document describes alternatives to the [Scheduler interface](/docs/background-processing#repeating-tasks).
...
### Limitations
Not included in the cloud licensing of TimescaleDB and only available in
