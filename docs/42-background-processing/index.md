...
The queue is instrumented to give you [observability](/docs/configuration-operations/observability) out of the box.
...
See [Observability for more details](/docs/configuration-operations/observability)
