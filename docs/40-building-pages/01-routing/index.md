...
See [Auth](/docs/architecture/auth) for all available middleware.
...
See [Views - Template Hierarchy](/docs/building-pages/views#template-hierarchy) for details on how layouts work.


## Rendering

Controllers render templates using Echo's `Render` method (see [Views](/docs/building-pages/views#rendering) for all rendering options):
...
See [Views](/docs/building-pages/views) for details on templates and the renderer.
