...
See [Logging](/docs/configuration-operations/observability/logging) for details on how this works.
...
See [Use Cases - Instrumentation](/docs/architecture/usecases#instrumentation)
